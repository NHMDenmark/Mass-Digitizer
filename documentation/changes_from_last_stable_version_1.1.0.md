...
The change here is that the radio buttons are updated to produce events rather than to be one of three states in the app. The radio button actions are acted upon which makes selecting MSO or MOS a more involved process it a much more active process as has been requested. 
