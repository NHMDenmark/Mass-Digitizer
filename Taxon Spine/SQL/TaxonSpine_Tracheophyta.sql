SELECT 
	...
	WHERE tdivis.ParentID = 317960 -- Plantae kingdom	
		AND tdivis.TaxonTreeDefID = 13 -- Discipline: Botany 
	GROUP BY TaxonFullName ; 
	
-- #I left the taxonFullName in there for sanity checking if joining this table on 'taxon' or perhaps others.
/*
Name	RankID
Class	60
Division	30
...
All these taxon ranks are included except 'life'.
*/
