...
layout_bluearea = [
    ...
    [sg.Button('SAVE', key="-SAVE-", button_color='seagreen'), sg.Push(background_color=blueArea),sg.Text('                                      ', background_color=blueArea), sg.Push(background_color=blueArea), sg.Button('Go Back', key="-GOBACK-", button_color='firebrick', pad=(120,0))]
]
