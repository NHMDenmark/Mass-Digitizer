...
set sqlfiles=PrepTypes TypeStatuses GeoRegions Chronostratigraphy Storage Highertaxa Species-Batch1 Species-Batch2 Species-Batch3 Species-Batch4 Subspecies VarForma-Batch1 VarForma-Batch2 Hybrids
