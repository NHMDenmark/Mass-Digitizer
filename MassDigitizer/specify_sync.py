...
class SpecifySync():
    ...
    def syncSpecifyCollections(self, csrftoken):
        """ 
    ...
    def syncTaxonomy(self, taxontreedefid, csrftoken):
        ...
        self.addSpecifyTaxonNamesToLocal(taxonranks, taxontreedefid, csrftoken)    
    ...
    def addSpecifyTaxonNamesToLocal(self, taxonranks, taxontreedefid, csrftoken):
                        ...
                        try:
                            ...
                            if len(dbTaxonName)==0: 
                                ...
                                if taxon_name_valid:
                                    classid = 'NULL' 
                                    if rankid >= 60:
                                        classid = self.searchParentTaxon(id, 60, csrftoken)
    ...
    def check_taxon_duplicates(self, fullname):
    ...
    def searchParentTaxon(self, taxonId, rankid, csrftoken):
