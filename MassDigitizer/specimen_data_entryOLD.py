...
def main(self):
    ...
    self.inputFieldList = ['inpStorage', 'cbxPrepType', 'cbxTypeStatus', 'inpNotes', 'radRadioSSO', 'radRadioMSO',
                           'radRadioMOS', 'inpContainerID', 'cbxGeoRegion', 'inpTaxonName',
                           'inpCatalogNumber', 'btnSave']
    self.inputFieldListSSO = ['inpStorage', 'cbxPrepType', 'cbxTypeStatus', 'inpNotes', 'inpCatalogNumber']
    self.focusIconList = ['inrStorage', 'inrPrepType', 'inrTypeStatus', 'inrNotes', 'inrRadioSSO', 'inrRadioMSO',
                          'inrRadioMOS', 'inrContainerID', 'inrGeoRegion',
...
def setup(self, collection_id):
    ...
    self.headers = ['id', 'spid', 'catalognumber', 'containertype', 'containername', 'taxonfullname', 'taxonname',
                    'taxonnameid',
    ...
    self.tableHeaders = ['id', 'catalognumber', 'taxonfullname', 'containertype', 'georegionname',
                         'storagename']  # Headers for previousRecordsTable
...
# Validation follows
print("real cat NOOOOOOOO|", self.collobj.catalogNumber,
      f"length cat no is :{len(self.collobj.catalogNumber)} and type is {type(self.collobj.catalogNumber)}")
