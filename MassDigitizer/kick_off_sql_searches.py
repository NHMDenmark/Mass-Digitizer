...
def auto_suggest_taxonomy(name, taxDefItemId=None, highLimit=2000):
...
###TEST AREA
outcome = auto_suggest_taxonomy('Rosa r', taxDefItemId=19)
# outcome = small_list_lookup('institution', 'k')
if outcome:
    print('outcome sørenme,,, ',type(outcome[0]), outcome)
    for elem in outcome:
    # print(elem['name'])
