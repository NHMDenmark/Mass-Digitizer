...
class AutoSuggest_popup():
    ...
    def auto_suggest_taxonomy(self, name, taxDefItemId=None, rowLimit=200):
    ...
    def autosuggest_gui(self, partialName):
        ...
        choices = self.auto_suggest_taxonomy(partialName)
        print(type(choices))
